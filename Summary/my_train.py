...
from helper import print_number_of_trainable_model_parameters,generate_and_print_summary_using_base_model,get_max_length
...
generate_and_print_summary_using_base_model(dataset, original_model, eval_tokenizer, 11)
