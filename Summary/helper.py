...
def generate_and_print_summary_using_base_model(dataset, model, tokenizer, index):
    """
    Generate a summary using the provided model and dataset at the specified index, and print the results.

    Args:
        dataset: The dataset containing dialogue and summary pairs.
        model: The pretrained model used for text generation.
        tokenizer: The tokenizer used for tokenization.
        index (int): The index of the dialogue and summary pair to use from the dataset.
    """
    # Set random seed for reproducibility
    seed = 42
    set_seed(seed)

    # Get the dialogue and summary from the dataset
...
def generate_and_print_summary_using_peft(dataset, model, tokenizer, index):
    """
    Generate a summary using the provided model and dataset at the specified index, and print the results.
...
def format_and_concatenate_prompt(sample):
    ...
    # Adding response header and the actual summary
